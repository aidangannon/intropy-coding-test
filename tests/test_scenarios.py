...
class TestMetricsScenarios(FastApiTestCase):
    ...
    def test_get_metrics_when_metric_not_found(self):
        ...
        scenario \
            .given_i_have_an_app_running() \
            .when_the_get_metrics_endpoint_is_called_with_metric_configuration_id(str(uuid.uuid4())) \
    ...
    def test_get_metrics_when_metric_exists(self):
        ...
        scenario \
            .given_i_have_an_app_running() \
            .when_the_get_metrics_endpoint_is_called_with_metric_configuration_id("def1fdce-dac9-4c5a-a4a1-d7cbd01f6ed6") \
